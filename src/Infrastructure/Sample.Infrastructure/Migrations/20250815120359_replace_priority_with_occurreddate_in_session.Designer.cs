...
namespace Sofa.CourseManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250815120359_replace_priority_with_occurreddate_in_session")]
    partial class replace_priority_with_occurreddate_in_session
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Domain.Institutes.Entities.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Domain.Institutes.Entities.FieldQuestionChoice", b =>
                {
                    b.HasOne("Sofa.CourseManagement.Domain.Institutes.Entities.FieldQuestion", "FieldQuestion")
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Domain.Institutes.Entities.Posts.PostQuestion", b =>
                {
                    b.HasOne("Sofa.CourseManagement.Domain.Institutes.Entities.Posts.Post", null)
                        .WithOne("Question")
                        .HasForeignKey("Sofa.CourseManagement.Domain.Institutes.Entities.Posts.PostQuestion", "PostId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
