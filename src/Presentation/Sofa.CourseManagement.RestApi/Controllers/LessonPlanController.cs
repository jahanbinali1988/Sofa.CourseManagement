...
namespace Sofa.CourseManagement.RestApi.Controllers
{
	public partial class InstituteController 
	{
		...
		public async Task<ActionResult<LessonPlanViewModel>> CreateAsync([FromQuery] string instituteId, [FromQuery] string fieldId,
			[FromQuery] string courseId, [FromQuery] string sessionId, [FromBody] CreateLessonPlanViewModel request)
		{
		...
		public async Task<ActionResult<LessonPlanViewModel>> GetLessonPlanByIdAsync([FromQuery] string instituteId, [FromQuery] string fieldId,
			[FromQuery] string courseId, [FromQuery] string sessionId, [FromQuery] string lessonplanId)
		{
		...
		public async Task<ActionResult<Pagination<LessonPlanViewModel>>> GetSessionListAsync([FromQuery] string instituteId, [FromQuery] string fieldId,
			[FromQuery] string courseId, [FromQuery] string sessionId, [FromQuery] GetListRequest request)
		{
		...
		public async Task<ActionResult<LessonPlanViewModel>> UpdateAsync([FromQuery] string instituteId, [FromQuery] string fieldId,
			[FromQuery] string courseId, [FromQuery] string sessionId, [FromQuery] string lessonplanId, [FromBody] CreateLessonPlanViewModel request)
		{
