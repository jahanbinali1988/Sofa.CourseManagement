...
{
	public class UpdateFieldQuestionChoiceCommandHandler : ICommandHandler<UpdateFieldQuestionChoiceCommand>
	{
		private readonly ICourseManagementUnitOfWork _unitOfWork;
		public UpdateFieldQuestionChoiceCommandHandler(ICourseManagementUnitOfWork unitOfWork)
		{
			_unitOfWork = unitOfWork;
		}
		public async Task<Unit> Handle(UpdateFieldQuestionChoiceCommand request, CancellationToken cancellationToken)
		{
