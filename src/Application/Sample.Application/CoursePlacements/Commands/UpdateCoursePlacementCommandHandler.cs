...
{
	public class UpdateCoursePlacementCommandHandler : ICommandHandler<UpdateCoursePlacementCommand>
	{
		private readonly ICourseManagementUnitOfWork _unitOfWork;
		public UpdateCoursePlacementCommandHandler(ICourseManagementUnitOfWork unitOfWork)
		{
			_unitOfWork = unitOfWork;
		}
		public async Task<Unit> Handle(UpdateCoursePlacementCommand request, CancellationToken cancellationToken)
		{
			...
			coursePlacement.Update(request.Title, request.CourseId, request.FieldId, request.InstituteId);
