...
namespace Sofa.CourseManagement.Application.Posts.DomainEventConsumers
{
	...
	{
		public DeleteTextPostDomainEventConsumer(ILogger<DeleteTextPostDomainEventConsumer> logger) : base(logger)
		{
		}

		protected override Task HandleEvent(DeleteTextPostDomainEvent notification, CancellationToken cancellationToken)
		{
