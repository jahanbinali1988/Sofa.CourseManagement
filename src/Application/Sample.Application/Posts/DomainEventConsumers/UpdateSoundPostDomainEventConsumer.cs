...
namespace Sofa.CourseManagement.Application.Posts.DomainEventConsumers
{
	...
	{
		public UpdateSoundPostDomainEventConsumer(ILogger<UpdateSoundPostDomainEventConsumer> logger) : base(logger)
		{
		}

		protected override Task HandleEvent(UpdateSoundPostDomainEvent notification, CancellationToken cancellationToken)
		{
